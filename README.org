...
:PROPERTIES:
:VISIBILITY: children
:header-args:sh:  :var sanitize="sanitize.css"
:header-args:sh+: :var forms="forms.css"
:header-args:sh+: :var typography="typography.css"
:header-args:sh+: :var org="org-styles.css"
:header-args:sh+: :var colors="colors.css"
:header-args:sh+: :results file
:END:
...
file.
#+begin_src sh :file docs/org.css
  cat $sanitize $typography $forms $org $colors | npx lightningcss-cli --minify
#+end_src
